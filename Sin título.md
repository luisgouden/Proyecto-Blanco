Te voy a pasar todo el contexto (cosmologia, nivel ontologico).
Quiero que lo leas y lo analices en frio.
No quiero que trabajemos aun con el, pero quiero que lo tengas como referente para los otros archivos y textos que quiero pasarte.

## 1. Situación y ambientación general

La historia se sitúa en **Heim**, un mundo insular compuesto por tres grandes islas-continente (**Orka, Teeli, Henso**) y una isla comercial (**Mieru**). Está habitado por diversas razas/civilizaciones, cada una con su propia cultura, historia y tecnología.
...
## 3. Geografía, razas y civilizaciones

### 3.1. Islas y configuración general
...
### 3.2. Razas y civilizaciones principales

Heim está dividido en cuatro razas principales, cada una con sistemas sociopolíticos, lenguas, rituales e imaginarios únicos. A esto se suma **Velk**, una organización transversal que actúa como secta, red de poder y guardiana de secretos.
...
- **Velk** (organización transversal)
    - Actúa como red de poder y guardiana de secretos.
    - Intenta controlar el relato histórico y busca acceder a sus dioses, los llamados Creadores.
...
- Además del matrimonio, el pacto generó una serie de cambios socioeconómicos:
    - Creación del **Consejo Económico de Heim**.
    - Reconocimiento del **Krag**, la moneda Orka, como moneda oficial de Teeli.

---

## 5. Sistema monetario y economía

### 5.1. Moneda común: El Krag
...
- Solo **Velk** adora a los llamados **Creadores**, figuras ausentes que habrían modelado Heim.
